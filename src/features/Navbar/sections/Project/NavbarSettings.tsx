...
export function NavbarSettings() {
  ...
  const meter = useStore(selectTransportTimeSignature);
  const swing = useStore(selectTransportSwing);
  return (
    <div className="group/tooltip relative">
      ...
      <NavbarHoverTooltip
        ...
        bgColor="bg-gradient-radial from-slate-900 to-zinc-900 backdrop-blur"
      >
