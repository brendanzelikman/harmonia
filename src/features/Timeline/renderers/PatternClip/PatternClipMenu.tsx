...
export const PatternClipMenu = (props: { left: number; top: number }) => {
  ...
  return (
    <div
      style={{ left, top }}
      className="absolute z-[31] text-xs flex flex-col gap-0.5 *:border-b font-light animate-in fade-in whitespace-nowrap w-48 p-[3px] px-1 rounded bg-slate-950/90 text-emerald-300/80"
    >
