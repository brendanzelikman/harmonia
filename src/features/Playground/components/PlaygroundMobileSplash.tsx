...
export const PlaygroundMobileSplash = () => {
  return (
    <div className="flex flex-col md:hidden h-full text-center px-8 animate-in fade-in justify-center items-center space-y-2 font-nunito md:text-2xl sm:text-xl text-md">
