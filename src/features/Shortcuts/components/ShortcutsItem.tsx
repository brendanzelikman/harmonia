import { formatShortcut, Hotkey } from "lib/hotkeys";
...
export const Shortcut = (
  ...
  return (
    <li className="px-8 flex gap-8 items-center whitespace-nowrap">
      ...
      <span className="text-bold text-center w-48 my-0.5 py-half bg-slate-800/50 border border-slate-50/25 rounded mr-2 shadow-xl">
