...
export const TICK_LIST = Object.values(DURATION_TICKS);
...
export const isStraightNote = (note: Timed<MidiNote>) => {
  return Object.values(STRAIGHT_DURATION_TICKS).includes(note.duration);
};

/** Checks if a given timed note is a dotted duration. */
export const isDottedNote = (note?: Timed<unknown>) => {
  if (note === undefined) return false;
  return Object.values(DOTTED_DURATION_TICKS).includes(note.duration);
};

/** Checks if a given timed note is a triplet duration. */
export const isTripletNote = (note?: Timed<unknown>) => {
  if (note === undefined) return false;
  return Object.values(TRIPLET_DURATION_TICKS).includes(note.duration);
};
...
export const isStraightSubdivision = (
  ...
  return Object.values(STRAIGHT_DURATION_SUBDIVISIONS).includes(
...
export const isDottedSubdivision = (
  ...
  return Object.values(DOTTED_DURATION_SUBDIVISIONS).includes(
...
export const isTripletSubdivision = (
  ...
  return Object.values(TRIPLET_DURATION_SUBDIVISIONS).includes(
