...
export type PatternClipColor = (typeof PATTERN_CLIP_COLORS)[number];
export const DEFAULT_PATTERN_CLIP_COLOR: PatternClipColor = "sky";
...
export const PATTERN_CLIP_THEMES: Record<PatternClipColor, PatternClipTheme> = {
  red: {
...
export const DEFAULT_PATTERN_CLIP_THEME =
  PATTERN_CLIP_THEMES[DEFAULT_PATTERN_CLIP_COLOR];
